                    ...
                    <div class="col-lg-4 col-md-6 white-bg" style=" border-radius: 25px;">
                        ...
                        <div class="login-fancy pb-10 clearfix" id = "forgot_password_area" style="display: none; padding-top: 10px !important;">
                            ...
                            <!-- <form class="" action="<?php echo site_url('login/reset_password');?>" method="post"> -->
                                ...
                                <div class="section-field mb-10">
                                    <label class="mb-10" for="name"><?php echo get_phrase('mobile'); ?>* </label>
                                    <!-- <input id="mobile" class="web form-control input-sm" type="text" placeholder="<?php //echo get_phrase('mobile'); ?>" name="mobile" required> -->
                                    
                                    <!-- phone with -->
                                    <div class="input-group">
                                        <input type="tel" id="mobile" placeholder="<?php echo get_phrase('mobile'); ?>" name="mobile" required class="web form-control input-sm">
                                ...
                                <div class="section-field mb-10">
                                    <label class="mb-10" for="name"><?php echo get_phrase('gender'); ?>* </label>
                                    <select name="gender" class="form-control selectboxit input-sm" data-validate="required" data-message-required="<?php echo get_phrase('gender_required');?>" value="" style="height: 35px !important; font-size:14px;" autofocus required >
