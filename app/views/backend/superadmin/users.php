		...
		<div class="tab-content">
            <div class="tab-pane box active" id="list2" style="padding: 5px">
                <div class="box-content">
                    <?php echo form_open(base_url() . 'superadmin/users' , array('class' => 'form-horizontal form-groups-bordered validate',  'enctype' => 'multipart/form-data','target'=>'_top'));?>
            ...
            <div class="tab-pane box active" id="list">
                ...
                <table class="table table-bordered table-striped table-condensed table-hover datatable" id="table_export1" role="grid" aria-describedby="teachers_info" style="width: 955px;">
                    ...
                    <tbody>
                        <?php
                            $count = 1; foreach($userData['Body']['data'] as $row):
                                ?>
                        <tr>
...
<script type="text/javascript">
    ...
    jQuery(document).ready(function($)
    {
        ...
        $("#activeInactive").click(function(){
            ...
            {
                // alert(sel);
                activeInactive_modal('<?php echo base_url();?>superadmin/users/active_inactive/'+"?ids="+sel);
                return true;
            }
            else
            {
